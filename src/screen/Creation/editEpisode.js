    ...
    <View style={{flex:1}}>
        ...
        <View style={{flex:1}}>
            ...
            <View style={{flexDirection:"row", marginTop:"5%", alignSelf: "center", flex:1}}>
                <Button block info style={styles.buttonAdd}><Text style={styles.textButtonAdd}>+ Image</Text></Button>
                <Button block info style={styles.buttonDeleteWebtoon}><Text style={styles.textButtonAdd}>Delete Episode</Text></Button>
            </View>
        </View>
    </View>
)}
